      ...
      <div className="min-h-screen relative overflow-hidden" style={{ background: `linear-gradient(135deg, #16A34A 0%, #000000 50%, #16A34A 100%)` }}>
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-bold mb-4 sm:mb-6 leading-tight min-h-[120px] sm:min-h-[150px] md:min-h-[200px] lg:min-h-[250px] flex items-center justify-center">
              <span 
                className="block"
                style={{ color: '#AFF912' }}
              >
